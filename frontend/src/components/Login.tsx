...
export default function Login() {
  ...
  async function handleFormSubmission(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Join room if room_id is in query params
      ...
      <div className="flex min-h-screen">
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-br from-primary/10 via-background to-background border-r border-border">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 max-w-sm">
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                Connect securely, chat privately, and stay in control of your
                conversations.
              </p>
            </div>
          ...
          <div className="text-xs text-muted-foreground">
            © 2025 Private Chat. All rights reserved.
          </div>
        </div>
          ...
          <div className="w-full max-w-sm space-y-8">
            ...
            <form onSubmit={handleFormSubmission} className="space-y-6">
              ...
              <Button
                ...
                disabled={isLoading}
                className={cn(
                  "w-full  text-white font-semibold py-3 rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
                  currentColorTheme === "Zinc"
                    ? "dark:bg-secondary hover:bg-neutral-800"
                    : "bg-primary"
                )}
              >
